...
func give_difficulty_texture():
	match difficulty:
		0: return preload("uid://5xkkyio5jiic")
		1: return preload("uid://5xkkyio5jiic")
		2: return preload("uid://5xkkyio5jiic")
		3: return preload("uid://5xkkyio5jiic")
		4: return preload("uid://5xkkyio5jiic")
		5: return preload("uid://5xkkyio5jiic")
		6: return preload("uid://5xkkyio5jiic")
		7: return preload("uid://5xkkyio5jiic")
		8: return preload("uid://cqjnb0h6rwr4")
		9: return preload("uid://vn51ekf68dup")
		10: return preload("uid://dkwt6tl575c4n")
		11: return preload("uid://bjeffo36f00oo")
		12: return preload("uid://xrk1vqvvxngk")
		13: return preload("uid://b36lkkrflgn")
		14: return preload("uid://cxqswniciubbq")
		15: return preload("uid://d4j5ogly1ikx")
